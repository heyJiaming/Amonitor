...
- (void)viewDidLoad {
    ...
    if (isSuccess) {
        ...
        self.preview.orientation = UIDeviceOrientationLandscapeRight;
        }else if(sataus == UIInterfaceOrientationLandscapeRight){
            self.preview.orientation = UIDeviceOrientationLandscapeLeft;
        }
...
- (XHScanView *)scanView{
    if (!_scanView) {
        ...
        _scanView.showSize = CGSizeMake( 300 , 300);
    }
    return _scanView;
}
...
- (BOOL)setUpSession:(NSError *)error{
    ...
    if ([self.captureSeesion canAddOutput:self.metadataOutPut]) {
        ...
        // 39 能够正常扫出条形码
        NSArray *types = @[AVMetadataObjectTypeEAN13Code, AVMetadataObjectTypeEAN8Code, AVMetadataObjectTypeCode128Code,AVMetadataObjectTypeInterleaved2of5Code, AVMetadataObjectTypeCode39Code,AVMetadataObjectTypeCode93Code,AVMetadataObjectTypeCode39Mod43Code,AVMetadataObjectTypeUPCECode,AVMetadataObjectTypePDF417Code,AVMetadataObjectTypeAztecCode,AVMetadataObjectTypeITF14Code,AVMetadataObjectTypeDataMatrixCode];
